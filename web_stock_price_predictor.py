...
# Proceed only if scaled_data is valid and has enough rows for the loop
if scaled_data is not None and len(scaled_data) > 100:
    x_data = []
    y_data = []
    ...
    st.error("Insufficient data for predictions. Check if the 'Close' column exists and has enough data.")
